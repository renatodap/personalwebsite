...
export const PROJECTS: Project[] = [
  {
    ...
    period: '2025 \u2013 Present',
    description: 'An AI platform that runs strategic analysis for Brazilian companies. It puts a business through SWOT, Porter\u2019s Five Forces, and nine other frameworks using multiple AI models. When one model goes down, the system routes to another.',
